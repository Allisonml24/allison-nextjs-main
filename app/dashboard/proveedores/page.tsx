...
export default function Proveedores() {
  ...
  const fetchProveedores = async () => {
    try {
      setIsLoading(true);
      const response = await axios.get('https://allison-django-main-c7mj.vercel.app/api/proveedores/');
    ...
    if (validateNombre(formData.nombre) && validateEmpresa(formData.empresa) && validateTelefono(formData.telefono)) {
      try {
        if (selectedProveedor) {
          ...
          await axios.put(`https://allison-django-main-c7mj.vercel.app/api/proveedores/${selectedProveedor.id}/`, formData);
          toast.success('Proveedor actualizado correctamente');
        } else {
          // Crear nuevo proveedor
          await axios.post('https://allison-django-main-c7mj.vercel.app/api/proveedores/', formData);
  ...
  const handleDeleteProveedor = async (id: number) => {
    try {
      await axios.delete(`https://allison-django-main-c7mj.vercel.app/api/proveedores/${id}/`);
