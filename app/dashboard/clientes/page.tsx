...
export default function Clientes() {
  ...
  const fetchClientes = async () => {
    try {
      setIsLoading(true);
      const response = await axios.get('https://allison-django-main-4m3m.vercel.app/api/clientes/');
  ...
  const handleSaveCliente = async (e: React.FormEvent) => {
    ...
    try {
      if (selectedCliente) {
        ...
        await axios.put(`https://allison-django-main-4m3m.vercel.app/api/clientes/${selectedCliente.id}/`, formData);
        toast.success('Cliente actualizado correctamente');
      } else {
        // Crear nuevo cliente
        await axios.post('https://allison-django-main-4m3m.vercel.app/api/clientes/', formData);
  ...
  const handleDeleteCliente = async (id: number) => {
    try {
      await axios.delete(`https://allison-django-main-4m3m.vercel.app/api/clientes/${id}/`);
