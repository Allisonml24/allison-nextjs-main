...
export default function NuevaCompra() {
    ...
    async function fetchData() {
      try {
        const [productosResponse, proveedoresResponse, comprasResponse] = await Promise.all([
          ...
          axios.get('https://allison-django-main-4m3m.vercel.app/api/proveedores/'),
          axios.get('https://allison-django-main-4m3m.vercel.app/api/compras/')
        ]);
  ...
  async function finalizarCompra() {
    ...
    try {
      const response = await axios.post('https://allison-django-main-4m3m.vercel.app/api/compras/', {
      ...
      const comprasResponse = await axios.get('https://allison-django-main-4m3m.vercel.app/api/compras/');
      setCompras(comprasResponse.data);
